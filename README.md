...
2) Добавлена возможность взаимодействия с предметами на локации
3) Добавлена функция остановки персонажа в том направлении, в котором он ходил последний раз
4) Теперь во время мини-игры "соедини провода" на заднем фоне видно открытый электрощиток (до этого он постоянно был закрыт)
5) Добавлена заготовка для проигрывания кат-сцен
